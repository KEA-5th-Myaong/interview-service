...
import myaong.popolog.interviewservice.service.CompanyService;
...
public class InterviewController {
    ...
    @Operation(summary = "API 명세서 v0.4 line 56", description = "기업 목록 조회 및 검색")
...
*/
    // 면접 생성 API
    @Operation(summary = "API 명세서 v0.4 line 57", description = "모의 면접 생성")
    @PostMapping
    ...
    // 메시지 전송 API
    @Operation(summary = "API 명세서 v0.4 line 58", description = "모의 면접 메시지 작성")
    ...
    // 메시지 수정 API
    @Operation(summary = "API 명세서 v0.4 line 59", description = "모의 면접 메시지 수정")
    ...
    // 새 질문 생성 API
    @Operation(summary = "API 명세서 v0.4 line 60", description = "새 질문 생성")
    ...
    // 꼬리 질문 생성 API
    @Operation(summary = "API 명세서 v0.4 line 61", description = "꼬리 질문 반환")
    ...
    // 면접 기록 조회 API
    @Operation(summary = "API 명세서 v0.4 line 63", description = "면접 기록 조회")
